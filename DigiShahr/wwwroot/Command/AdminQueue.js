...
$("#search").click(function () {
    ...
    $.get("/Admin/Queue/pList?PageId=" + PageId + "&InPageCount=" + InPageCount + "&QueueId=" + $("#QueueId").val() + "&phoneNumber=" + $("#phoneNumber").val(), function (result) {
...
function Info(Id) {
    ...
    $.get("/Admin/Queue/pInfo?Id=" + Id, function (result) {
