...
namespace DigiShahr.Areas.Admin.Controllers
{
    ...
    public class ServiceController : Controller
    {
        ...
        {
            return ViewComponent("ServiceInfo", new { Id = Id });
        }
        ...
        [HttpGet]
        public IActionResult pServiceList(Paging paging, string ServiceName, string phoneNumber)
        {
            return ViewComponent("ServiceList", new { Paging = paging, ServiceName = ServiceName, phoneNumber = phoneNumber });
        }
